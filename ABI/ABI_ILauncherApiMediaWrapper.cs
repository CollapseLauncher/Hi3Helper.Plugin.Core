...
internal sealed unsafe class ABI_ILauncherApiMediaWrapper
{
    ...
    internal static int ABI_GetBackgroundEntries(ComInterfaceDispatch* thisNative, nint* handleNativeParam, int* countNativeParam, int* isDisposableNativeParam, int* isAllocatedNativeParam)
    {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvMemberFunction)])]
    internal static int ABI_GetLogoOverlayEntries(ComInterfaceDispatch* thisNative, nint* handleNativeParam, int* countNativeParam, int* isDisposableNativeParam, int* isAllocatedNativeParam)
    {
        ref nint handleNative = ref *handleNativeParam;
        ref int countNative = ref *countNativeParam;
        ref int isDisposableNative = ref *isDisposableNativeParam;
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvMemberFunction)])]
    internal static int ABI_GetBackgroundFlag(ComInterfaceDispatch* thisNative, Management.Api.LauncherBackgroundFlag* resultNativeParam)
    {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvMemberFunction)])]
    internal static int ABI_GetLogoFlag(ComInterfaceDispatch* thisNative, Management.Api.LauncherBackgroundFlag* resultNativeParam)
    {
        ref Management.Api.LauncherBackgroundFlag resultNative = ref *resultNativeParam;
        int retVal;
        try
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvMemberFunction)])]
    internal static int ABI_GetBackgroundSpriteFps(ComInterfaceDispatch* thisNative, float* resultNativeParam)
    {
