...
- **Versioned extension API** — optional feature sets (`v0.1-update1` through `v0.1-update6`) for game launch, Discord Rich Presence, resizable-window hook, download throttling, install progress, and declarative game settings are all opt-in
